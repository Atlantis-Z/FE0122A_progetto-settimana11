  ...
  template: `
    <div class="container">
      <div class="caricamento text-center">
        <div *ngIf="isLoading" class="spinner-grow text-light" style="width: 25px; height: 25px" role="status"></div>
        <div *ngIf="isLoading" class="spinner-grow text-dark" style="width: 25px; height: 25px" role="status"></div>
        <div *ngIf="isLoading" class="spinner-grow text-danger" style="width: 25px; height: 25px" role="status"></div>
      ...
      <div class="row justify-content-around ">
        <div *ngFor="let movie of movies" class="card text-center m-2 p-2 shadow-lg p-3 mb-5 rounded">
          ...
          <p class="rounded bg-light" *ngIf="!movie.like" (click)="miPiace(movie)">👍</p>
        </div>
      </div>
    </div>
